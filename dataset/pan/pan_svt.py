...
svt_root_dir = '../dataset/StreetViewText/'
svt_train_data_dir = svt_root_dir + 'train_images/'
svt_train_gt_dir = svt_root_dir + 'train_gts/'
svt_test_data_dir = svt_root_dir + 'test_images/'
svt_test_gt_dir = svt_root_dir + 'test_gts/'
...
class PAN_SVT(data.Dataset):
    def __init__(self,
        ...
        if split == 'train':
            data_dirs = [svt_train_data_dir]
            gt_dirs = [svt_train_gt_dir]
        elif split == 'test':
            data_dirs = [svt_test_data_dir]
            gt_dirs = [svt_test_gt_dir]
        else:
